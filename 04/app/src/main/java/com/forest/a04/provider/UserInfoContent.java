...
import com.forest.a04.database.UserDBHelper;

public class UserInfoContent implements BaseColumns {
    //这里的名称必须与AndroidMainfest.xml 里的android:authorities保持一致
    public static final String AUTHORITIES = "com.forest.a64.provider.UserInfoProvider";
    // 表名
