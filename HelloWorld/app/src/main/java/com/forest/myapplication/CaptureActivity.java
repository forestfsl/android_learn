...
import com.forest.myapplication.util.DateUtil;
...
public class CaptureActivity extends AppCompatActivity implements View.OnClickListener ,View.OnLongClickListener{
    ...
    private String[] mChatStr = {"你吃饭了么","现在天天下大雨","条条大路通罗马","现在是一个非常和平的社会","我们晚上去看电影吧"};

    @Override
    public void onClick(View v) {//一旦监听到点击动作，就出发监听器的onClick 方法
        if (v.getId() == R.id.btn_chat){//点击了聊天按钮，这个文本视图添加聊天文字
    ...
    public boolean onLongClick(View v) {
        //长按了按钮btn_chat,则清空文件视图tv_capture
